...
const categories = [
  ...
  { id: 3, name: "Breakfast/Dinner", description: "Start your day with healthy and tasty breakfast recipes.", image: "./images/breakfast.avif" },
        ...
        {filteredCategories.length > 0 ? (
          filteredCategories.map((category) => (
            <div key={category.id} className="category-card">
              ...
              <button onClick={() => handleClick(category.name)} className="view-btn">
                Recipes
              </button>
            </div>
          ))
